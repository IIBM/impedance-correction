...
;|//////////////////////////////////////|\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\|;
;|////| Procesamiento de muestras del ADC en RAM para obtener valor pico |\\\\|;
;|//////////////////////////////////////|\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\|;
;
; Al finalizar, R2 contendrá el valor pico en bits, de la medición muestreada en
; RAM por el ADC. Salva todos los registros que arruina.
;
GET_THE_PEAK_VALUE_IN_R2_FROM_ADC_RAM_TABLE:
    push    R1
    push    param
    push    ZH
    push    ZL ; Registros salvados en el stack
...
;
;    rcall   GET_THE_PEAK_VALUE_IN_R2_FROM_ADC_RAM_TABLE
;here:
;    rjmp    here
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
